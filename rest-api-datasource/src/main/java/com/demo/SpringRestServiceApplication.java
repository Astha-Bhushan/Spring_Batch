...
public class SpringRestServiceApplication {
	...
	public StudentResponse createStudent(@RequestBody StudentResponse stu)
	{
		System.out.println("Student Created having Id : " + stu.getId());
		return new StudentResponse(stu.getId() , stu.getFirstName() , stu.getLastName() , stu.getEmail());
	}
}
