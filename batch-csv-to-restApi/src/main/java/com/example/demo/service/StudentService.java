...
public class StudentService {
	...
	public List<StudentResponse> restCallToGetStudents() {
		...
		StudentResponse[] studentResponseArray = restTemplate.getForObject("http://localhost:8080/api/v1/students",
	...
	public StudentResponse restCallToCreateStudent(StudentCsv studentCsv) {
		...
		return restTemplate.postForObject("http://localhost:8080/api/v1/createStudent", 
				studentCsv, 
				StudentResponse.class);
	}
}
